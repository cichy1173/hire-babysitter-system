...
return [
    ...
    'attributes' => [
        'advert_type_select' => 'typ ogłoszenia',
        'input_advert_title' => 'tytuł ogłoszenia',
        'input_advert_content' => 'treść ogłoszenia',
        'input_hour_rate' => 'stawka godzinowa',
        'input_min_child_age' => 'minimalny wiek dziecka',
        'input_max_child_age' => 'maksymalny wiek dziecka',
        'input_number_of_childs' => 'liczba dzieci',
        'input_advert_from' => 'ogłoszenie od',
        'input_advert_to' => 'ogłoszenie do',
        'input_supervise_from' => 'opieka od',
        'input_supervise_to' => 'opieka do',
        'input_country' => 'kraj',
        'input_voivodeship' => 'województwo',
        'input_city' => 'miasto',
        'input_district' => 'dzielnica',
        'input_skill' => 'umiejętności',
    ],
];
